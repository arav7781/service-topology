...
argument-hint: '<scan|master|micro <service>|all|refresh> [args]'
---
...
Invoke as `/topology-cartographer <mode> [args]` or in natural language ("use the
...
**Custom agents** (`.github/agents/` directory): `topology-extractor`,
